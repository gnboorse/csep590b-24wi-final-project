...
int main(int argc, char **argv) {
    ...
    char *inputFileName = wbPath_join(wbDirectory_current(), "test-normalizer", current_timestamp, "query.raw");
    char *outputFileName = wbPath_join(wbDirectory_current(), "test-normalizer", current_timestamp, "normalized_query.raw");
